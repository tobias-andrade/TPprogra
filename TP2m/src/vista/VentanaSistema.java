...
public class VentanaSistema extends JFrame implements MouseListener,IVista {
	...
	private JButton btnAñadirServicio = new JButton("Añadir");
	...
	public VentanaSistema(Controlador aclist) {
		...
		JLabel lblNewLabel_11 = new JLabel("NÂ° identificacion");
		...
		btnAñadirServicio.addActionListener(controlador);
		panel_8.add(btnAñadirServicio);
